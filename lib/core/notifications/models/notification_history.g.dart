...
void _notificationHistorySerialize(
  ...
  writer.writeBool(offsets[2], object.triggered);
...
NotificationHistory _notificationHistoryDeserialize(
  ...
  object.triggered = reader.readBool(offsets[2]);
  object.type =
      _NotificationHistorytypeValueEnumMap[reader.readByteOrNull(offsets[3])] ??
...
const _NotificationHistorytypeValueEnumMap = {
  0: NotificationType.morning,
  1: NotificationType.commute,
  2: NotificationType.evening,
  3: NotificationType.bedtime,
  4: NotificationType.milestone,
  5: NotificationType.companionCheckIn,
};
...
extension NotificationHistoryQueryWhereSort
  ...
  QueryBuilder<NotificationHistory, NotificationHistory, QAfterWhere>
      anyTimestamp() {
    return QueryBuilder.apply(this, (query) {

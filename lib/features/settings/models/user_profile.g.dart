...
const UserProfileSchema = CollectionSchema(
  ...
  properties: {
    r'collegeEndTime': PropertySchema(
      id: 0,
      name: r'collegeEndTime',
      type: IsarType.dateTime,
    ),
    r'collegeStartTime': PropertySchema(
      id: 1,
      name: r'collegeStartTime',
      type: IsarType.dateTime,
    ),
...
void _userProfileSerialize(
  ...
  writer.writeDateTime(offsets[0], object.collegeEndTime);
  writer.writeDateTime(offsets[1], object.collegeStartTime);
  writer.writeDateTime(offsets[2], object.createdAt);
  writer.writeDateTime(offsets[3], object.lastUpdatedAt);
  writer.writeString(offsets[4], object.name);
  writer.writeDateTime(offsets[5], object.sleepTime);
...
UserProfile _userProfileDeserialize(
  ...
  object.collegeEndTime = reader.readDateTime(offsets[0]);
  object.collegeStartTime = reader.readDateTime(offsets[1]);
  object.createdAt = reader.readDateTime(offsets[2]);
  object.id = id;
  object.lastUpdatedAt = reader.readDateTime(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.sleepTime = reader.readDateTime(offsets[5]);
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      collegeEndTimeEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'collegeEndTime',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      collegeStartTimeEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'collegeStartTime',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> wakeTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'wakeTime',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> wakeTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByCollegeEndTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collegeEndTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByCollegeEndTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collegeEndTime', Sort.desc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByCollegeStartTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collegeStartTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByCollegeStartTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collegeStartTime', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortBySleepTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sleepTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortBySleepTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sleepTime', Sort.desc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByWakeTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wakeTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByWakeTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByCollegeEndTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collegeEndTime', Sort.asc);
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenBySleepTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sleepTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenBySleepTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sleepTime', Sort.desc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByWakeTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wakeTime', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByWakeTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wakeTime', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByCollegeEndTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'collegeEndTime');
    });
  }

  QueryBuilder<UserProfile, UserProfile, QDistinct>
      distinctByCollegeStartTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'collegeStartTime');
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctBySleepTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'sleepTime');
    });
  }

  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByWakeTime() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, DateTime, QQueryOperations>
      collegeEndTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'collegeEndTime');
    });
  }

  QueryBuilder<UserProfile, DateTime, QQueryOperations>
      collegeStartTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'collegeStartTime');
    });
  }
  ...
  QueryBuilder<UserProfile, DateTime, QQueryOperations> sleepTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sleepTime');
    });
  }

  QueryBuilder<UserProfile, DateTime, QQueryOperations> wakeTimeProperty() {
    return QueryBuilder.apply(this, (query) {

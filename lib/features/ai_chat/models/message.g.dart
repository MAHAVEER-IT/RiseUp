...
const MessageSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'sender': PropertySchema(
      ...
      name: r'sender',
      type: IsarType.byte,
      enumMap: _MessagesenderEnumValueMap,
    ),
...
void _messageSerialize(
  ...
  writer.writeByte(offsets[1], object.sender.index);
...
Message _messageDeserialize(
  ...
  object.id = id;
  object.sender =
      _MessagesenderValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          SenderType.user;
...
P _messageDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_MessagesenderValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _MessagesenderEnumValueMap = {
  'user': 0,
  'ai': 1,
};
const _MessagesenderValueEnumMap = {
  0: SenderType.user,
  1: SenderType.ai,
};
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, SenderType, QQueryOperations> senderProperty() {
    return QueryBuilder.apply(this, (query) {

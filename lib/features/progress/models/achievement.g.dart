...
extension AchievementQueryWhereSort
  ...
  QueryBuilder<Achievement, Achievement, QAfterWhere> anyUnlockedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension AchievementQueryWhere
  ...
  QueryBuilder<Achievement, Achievement, QAfterWhereClause> unlockedAtEqualTo(
      DateTime unlockedAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Achievement, Achievement, QAfterWhereClause> unlockedAtLessThan(
    DateTime unlockedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Achievement, Achievement, QAfterWhereClause> unlockedAtBetween(
